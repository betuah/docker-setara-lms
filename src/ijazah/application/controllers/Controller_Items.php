	...
	*/
	public function fetchBrandData()
	{
		...
		foreach ($data as $key => $value) {
			...
			$status = ($value['active'] == 1) ? '<span class="label label-success">Paket A</span>' : (($value['active'] == 2) ? '<span class="label label-info">Paket B</span>' : '<span class="label label-danger">Paket C</span>');

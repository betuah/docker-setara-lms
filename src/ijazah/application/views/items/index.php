...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Nomor Ijazah</li>
    </ol>
  </section>
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createBrand', $user_permission)): ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addBrandModal">Tambah Nomor Ijazah Baru</button>
          <br /> <br />
        <?php endif; ?>
      ...
      <form role="form" action="<?php echo base_url('Controller_Items/create') ?>" method="post" id="createBrandForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="brand_name">Nomor Ijazah</label>
            <input type="text" class="form-control" id="brand_name" name="brand_name" placeholder="Enter" autocomplete="off">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="active">Program</label>

<?php
    ...
    if($_SERVER['SERVER_NAME'] == 'lms.seamolec.org'){
		header('Location: http://lms.seamolec.org/siajar-lms.php');
    }elseif($_SERVER['SERVER_NAME'] == 'smarujukan.seamolec.org'){
		header('Location: http://smarujukan.seamolec.org/smarujukan.php');
    }elseif($_SERVER['SERVER_NAME'] == 'setara.kemdikbud.go.id'){
		header('Location: http://setara.kemdikbud.go.id/kesetaraan');
    }
?>
...
<html lang="en">
    <head>
        ...
        <title>SIAJAR LMS | Sekolah Terbuka</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-7 col-sm-6 priorty wow fadeInLeft">
                        <h2 class="heading bottom25">Selamat datang di SIAJAR  <span class="divider-left"></span></h2>
                        <p class="half_space text-justify">Secara tersistem SIAJAR terhubung sekaligus terintegrasi dengan <a href="sumberbelajar.seamolec.org"><b>Sumber Belajar</b></a> sehingga guru dapat mengelola pembelajaran dengan aman dan cepat. SIAJAR dirancang untuk memberikan kemudahan tampilan sekaligus kontrol dalam pelaksanaan kelas digital baik untuk SMA Terbuka dan SMK PJJ (Pendidikan Jarak Jauh) serta mendukung program Sekolah Terbuka di Jawa Barat.<br><br>
                        Sebagai <i>Learning Management System</i> (LMS), SIAJAR menyediakan kelengkapan pembelajaran dari perancangan, pelaksanaan pembelajaran, sampai ke penilaian. Karena Penilaian Akhir seperti PTS (Penilaian Tengah Semester), PAS (Penilaian Akhir Semester), dan PAT (Penilaian Akhir Tahun) dilaksanakan di sekolah, maka SIAJAR hanya menyediakan materi pembelajaran dan soal yang dikembangkan oleh guru sebagai wahana berlatih menghadapi Penilaian Akhir tahun dan Ujian Nasional yang sesungguhnya.
</p>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-4 footer_panel bottom25">
                        ...
                        <p>SIAJAR adalah sebuah aplikasi <i>Learning Management System</i> yang dirancang untuk pembelajaran jarak jauh SMA dan SMK di Jawa Barat.</p>
                    </div>
                    <div class="col-md-4 col-sm-4 footer_panel bottom25">
                    </div>
                    <div class="col-md-4 col-sm-4 footer_panel bottom25">
                        ...
                        Jl. Cabe Raya, Pondok Cabe Pamulang - 15418<br>

...
function generate_menu($level, $is_wali=false) {
	...
	if ($level == "admin") {
		$menu .= 	'
					<li><a href="'.base_url().'data_guru"><i class="pe-7s-user"></i><p>Data Tutor</p></a></li>
					<li><a href="'.base_url().'data_siswa"><i class="pe-7s-users"></i><p>Data Warga Belajar</p></a></li>
					...
					<li style="display: none;"><a href="'.base_url().'data_kelas"><i class="pe-7s-home"></i><p>Data Kelas</p></a></li>
					<li style="display: none;"><a href="'.base_url().'data_mapel"><i class="pe-7s-ticket"></i><p>Data Mapel</p></a></li>
		...
		$menu .= $is_wali == TRUE ? '<li class="devider"></li>
		                            ...
		                            <li style="display: none;"><a href="'.base_url().'n_absensi"><i class="pe-7s-date"></i><p>Absensi</p></a></li>
		                            ...
		                            <li style="display: none;"><a href="'.base_url().'cetak_leger"><i class="pe-7s-print"></i><p>Cetak Leger</p></a></li>
		                            <li><a href="'.base_url().'home/ubah_password"><i class="pe-7s-user"></i><p>Ubah Password</p></a></li>' :
		                                '<li><a href="'.base_url().'home/ubah_password"><i class="pe-7s-user"></i><p>Ubah Password</p></a></li>';
	} else if ($level == "siswa") {
		$menu .= 	'

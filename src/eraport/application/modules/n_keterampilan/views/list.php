<div class="row">
    <div class="col-md-12">
        <div class="alert alert-warning" style="color: #000">
            ...
            <ul>
                ...
                <li>Jika MODUL belum ada, silakan klik tombol <b><i>Tambah Modul</i></b>. Untuk mengubah atau menghapus nama Modul, silakan klik tombol "<i class="fa fa-pencil"></i>" atau "<i class="fa fa-remove"></i>". </li>
                <li>Untuk mengisikan nilai keterampilan pada masing-masing Modul, silakan klik nama Modul, dan akan muncul daftar siswa serta isian nilai. Nilai dalam <b><i>skala 1-100</i></b>. Jangan lupa klik tombol <b><i>Simpan</i></b> di sebelah bawah.</li>
            </ul>
        </div>
    </div>
    <div class="col-md-12">
    ...
    <div class="col-md-5">
        <div class="card">
            ...
            <div class="content">
                <p>
                    <a href="#" onclick="return edit(0);" class="btn btn-info"><i class="fa fa-plus-circle"></i> Tambah Modul</a>
                </p>
                <ul class="list-group" id="list_kd">
                    ...
                    <?php
                        ...
                        echo '<div class="alert alert-info">Belum ada Modul diinputkan</div>';
                    }
                    ?>
                </ul>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Set Modul</h4>
            </div>
...
<script type="text/javascript">
    ...
    function view_kd(id, kelas) {
        ...
        if (id == 0 && kelas == 0) {
            $("#load_nilai").html('<div class="alert alert-warning">Silakan pilih Modul di samping</div>');
        } else {
            $("#id_mapel_kd").val(id);

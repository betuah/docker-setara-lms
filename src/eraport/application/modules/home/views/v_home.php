<div class="card">
    <div class="header">
        <h4 class="title">Selamat datang di Aplikasi E-Raport Pendidikan Kesetaraan</h4>
    </div>
    <div class="content">
        <?php
...
<script type="text/javascript">
    ...
    if ($nilai < 2) {
        echo "swal(
          'Waduuhhh..',
          '<img src=\\'http://4.bp.blogspot.com/-hZpp9lVapgw/VJZ6grV3NBI/AAAAAAAAAbw/tltdqsQnaFQ/s1600/angerywoman.jpg\\' style=\\'width: 160px; height: 180px\\'><br><br>Pak Tutor/Bu Tutor ngisi nilainya belum lengkap..!!<br>".$ket."',
          'error'
        );";
    } else {
        echo "swal(
          'Baguss..',
          '<img src=\\'https://gozzip.id/system/App/BlogBody/photos/000/118/272/original/4a8a08f09d37b73795649038408b5f33.jpg\\' style=\\'width: 390px; height: 260px\\'><br><br>Pak Tutor/Bu Tutor sudah ngisi nilai..!!<br>".$ket."',
          'success'
        );";
    }
	?>

...
class Set_mapel extends CI_Controller {
    ...
    public function datatable() {
        ...
        $d_total_row = $this->db->query("SELECT
                                        ...
                                        WHERE b.npsn='$npsn' AND a.tasm = '".$this->d['tasm']."'
        ...
        $q_datanya = $this->db->query("SELECT
                                    ...
                                    INNER JOIN m_kelas c ON a.id_kelas = c.id
                                    INNER JOIN m_mapel d ON a.id_mapel = d.id
                                    WHERE b.npsn='$npsn' AND a.tasm = '".$this->d['tasm']."' AND
    ...
    public function edit($id) {
        ...
        $q = $this->db->query("SELECT id, nama FROM m_guru WHERE npsn='$npsn' ORDER BY id ASC");

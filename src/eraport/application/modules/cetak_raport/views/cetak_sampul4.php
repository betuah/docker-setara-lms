...
<body style="height:12in">
	<table>
		<tr>
			<td width="10%">
			<img src="<?php echo base_url(); ?>aset/img/logo_kemdikbud.png" style="margin-top: 10px; width: 125px;">
			</td>
		...
		<tr><td colspan="2">
			...
			<table width="100%">
				...
				<tr><td>10.</td><td>Diterima di Satuan Pendidikan ini</td><td>:</td><td></td></tr>
				...
				<tr><td></td><td>a. Nama Satuan Pendidikan</td><td>:</td><td><?php echo $ds['sek_asal']; ?></td></tr>
	...
	<div style="margin-left: 120px; display: inline; float: left;">
		DKI Jakarta, <?php echo tjs($ds['diterima_tgl'],"l"); ?><br>

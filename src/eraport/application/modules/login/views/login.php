        ...
        <div class="card">
            ...
            <div class="content">
                <div class="alert alert-info">
                    <b>Selamat datang di Aplikasi E-Raport Pendidikan Kesetaraan</b>
                    <br>Silakan login dengan username dan password yang telah diberikan oleh Admin Satuan Pendidikan. Jika belum mendapatkan, silakan hubungi Admin.
                </div>
        ...
        $("#<?php echo $nama_form; ?>").on("submit", function() {
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    ...
                    $("#tbLogin").html('<i class="fa fa-spinner fa-spin"></i> Memuat ...');
                },
                success: function(r) {

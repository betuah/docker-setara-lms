...
class N_pengetahuan extends CI_Controller {
    ...
    public function cetak($bawa) {
        ...
        $html = '<p align="left"><b>REKAP NILAI PENGETAHUAN</b>
                <br>
                Mata Pelajaran : '.$detil_guru['nmmapel'].', Kelas : '.$detil_guru['nmkelas'].', Tutor : '.$detil_guru['nmguru'].'. Tahun Pelajaran '.$detil_guru['tasm'].'<hr style="border: solid 1px #000; margin-top: -10px"></p>';
        ...
        */
        ...
        $html = '<p align="left"><b>REKAP NILAI PENGETAHUAN</b>
                <br>
                Mata Pelajaran : '.$detil_guru['nmmapel'].', Kelas : '.$detil_guru['nmkelas'].', Tutor : '.$detil_guru['nmguru'].'. Tahun Pelajaran '.$this->d['tasm'].'<hr style="border: solid 1px #000; margin-top: -10px"></p>
    ...
    public function import($bawa) {
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('A2', 'Cukup isikan di isian nilai Per Modul');
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('A5', 'ID Tutor');
        ...
        if (!empty($d_nilai)) {
            ...
            foreach ($d_nilai as $ke => $dn) {
                ...
                if (!empty($d_kd)) {
                    ...
                    exit("Modul masih kosong. Silakan diisi");
                }
        ...
        if($file[$length -1] == 'xlsx' || $file[$length -1] == 'xls') {
            ...
            for ($b = $idx_baris_mulai; $b < $idx_baris_selesai; $b++) {
                ...
                for ($k = $idx_kolom_mulai; $k < ($idx_kolom_hide); $k++) {
                    ...
                    //echo $pc_hide[1];
                    /*
                    echo "Id_Warga Belajar : ".$id_siswa.", ";
                    echo "NIlai : ".$nilai.", ";

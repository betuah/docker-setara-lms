    ...
    <div class="col-md-12">
        <div class="alert alert-warning" style="color: #000">
            ...
            <ul>
                ...
                <li>Untuk mengisikan nilai pengetahuan pada masing-masing Modul, silakan klik nama Modul, dan akan muncul daftar siswa serta isian nilai. Nilai dalam <b><i>skala 1-100</i></b>. Jangan lupa klik tombol <b><i>Simpan</i></b> di sebelah bawah.</li>
            </ul>
        </div>
    </div>
    <div class="col-md-12">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.length > 0) {
                    ...
                    h += '<div class="alert alert-info">Modul Belum satupun diinputkan</div>';
                }

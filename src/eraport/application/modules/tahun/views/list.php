<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h4 class="title">Tahun Ajaran Aktif</h4>
            ...
            <div class="content">
                ...
                <table class="table table-hover table-striped" id="datatabel" style="width: 100%">
                    <thead>
                        ...
                        <td width="20%">Kepala Satuan Pendidikan</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="tahun" class="col-sm-3 control-label">Paket Kompetensi</label>
                    <div class="col-sm-9">
                        <?=form_dropdown('semester',$p_semester,'','class="form-control" id="semester" required'); ?>
                    </div>
                </div>
                <div class="form-group">
                    <label for="tahun" class="col-sm-3 control-label">Kepala Satuan Pendidikan</label>
                    <div class="col-sm-9">
                        <input type="text" name="nama_kepsek"  class="form-control" id="nama_kepsek" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="tahun" class="col-sm-3 control-label">NIP Kepala Satuan Pendidikan</label>
                    <div class="col-sm-9">

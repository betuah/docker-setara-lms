        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="id_kelas" class="col-sm-3 control-label">Tingkatan Kelas</label>
                    <div class="col-sm-9">
                        <?php echo form_dropdown('id_kelas',$p_kelas,'','class="form-control" required id="id_kelas"'); ?>
                    </div>
                </div>
                <div class="form-group">
                    <label for="id_guru" class="col-sm-3 control-label">Tutor</label>
                    <div class="col-sm-9">

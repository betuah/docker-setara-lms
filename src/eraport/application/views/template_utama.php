...
<head>
	<meta charset="utf-8" />
	<link rel="icon" type="image/png" href="<?=base_url('aset/img/icon-kemdikbud.png')?>">
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
	<title>E-Raport Pendidikan Kesetaraan</title>
    	...
    	<div class="sidebar-wrapper">
            <div class="logo">
                <a href="<?php echo base_url(); ?>" class="simple-text">
                    <i><img src="<?php echo base_url(); ?>aset/img/icon-kemdikbud.png" style="width: 100px;"></i>
                </a>
            </div>
            <ul class="nav">
                <?php
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url(); ?>"><i><img src="<?php echo base_url(); ?>aset/img/logo_kemdikbud.png" style="width: 50px;"></i> E-Raport Pendidikan Kesetaraan</a>
                </div>

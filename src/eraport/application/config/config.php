...
$config['base_url'] = 'http://setara.kemdikbud.go.id/eraport/';
...
$config['nama_sekolah'] = "Direktorat Pendidikan Masyarakat dan Pendidikan Khusus";
$config['alamat_sekolah'] = "DKI Jakarta";
$config['kota_sekolah'] = "DKI Jakarta";

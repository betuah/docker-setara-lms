<?php
    ...
    $countUser  = $ClassUser->CountUserByProgram("Paket C");
    $countguru = $ClassUser->CountGuruByProgram("Paket C");
    $countsiswa = $ClassUser->CountSiswaByProgram("Paket C");
    $countmedia = $ClassMedia->CountMediaByKategori("5acadc80865eacc15c8f190d");
?>
...
<html lang="en">
    <head>
        ...
        <title>UMT Online | Universitas Muhammadiyah Tangerang</title>
        ...
        <link href="assets/images-front/umt/umt.gif" rel="shortcut icon">
    ...
    <body class="pushmenu-push">
                ...
                <div class="modal-content">
                    ...
                    <div style="display: flex">
                        <div class="sign-avatar">
                            <img src="assets/images-front/umt/umt.gif" style="border-radius: 0px !important;" alt="">
                        </div>
                    </div>
                    <div class="modal-header">
                        <h4 class="modal-title text-center">UMT Online</h4>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#menu1">Mahasiswa</a></li>
                            <li><a data-toggle="tab" href="#menu2">Dosen</a></li>
                        </ul>
                        <br />
                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="./">
                            <img src="assets/images-front/umt/umt-logo.png" class="logo" alt="">
                        </a>
                    </div>
        ...
        <section class="" id="text_rotator_parent">
            <div id="text_rotator" class="owl-carousel">
		        <div class="item" style="background:url(assets/images-front/umt/banner-1.png) no-repeat; background-size: cover;">
                ...
                <div class="item" style="background:url(assets/images-front/umt/banner-2.png) no-repeat; background-size: cover;">
                    <div class="rotate_caption text-center">
                        <h1 style="opacity: 1.0;">&nbsp;</h1>
                        <p style="opacity: 1.0;">&nbsp;<br><b>&nbsp;</b>&nbsp;</p>
                        <br>
                ...
                <div class="item" style="background:url(assets/images-front/umt/banner-3.png) no-repeat; background-size: cover;">
                    <div class="rotate_caption text-center">
                        <h1 style="opacity: 1.0;">&nbsp;</h1>
                        <p style="opacity: 1.0;">&nbsp;<br><b>&nbsp;</b>&nbsp;</p>
                        <br>
                ...
                <div class="item" style="background:url(assets/images-front/umt/banner-4.png) no-repeat; background-size: cover;">
                    <div class="rotate_caption text-center">
                        <h1 style="opacity: 1.0;">&nbsp;</h1>
                        <p style="opacity: 1.0;">&nbsp;<br><b>&nbsp;</b>&nbsp;</p>
                        <br>
                ...
                <div class="item" style="background:url(assets/images-front/umt/banner-5.png) no-repeat; background-size: cover;">
                    <div class="rotate_caption text-center">
                        <h1 style="opacity: 1.0;">&nbsp;</h1>
                        <p style="opacity: 1.0;">&nbsp;<br><b>&nbsp;</b>&nbsp;</p>
                        <br>
        ...
        <section style="-moz-box-shadow: 0 3px 3px -3px rgba(0,0,0,.35); -o-box-shadow: 0 3px 3px -3px rgba(0,0,0,.35); -webkit-box-shadow: 0 3px 3px -3px rgba(0,0,0,.35); box-shadow: 0 3px 3px -3px rgba(0,0,0,.35);">
            ...
            <div id="owl-demo" class="owl-carousel owl-theme" style="opacity: 1; display: block;">
                ...
                <div class="owl-item">
                    <div align="center">
                        <a href="http://umt-online.seamolec.org/" target="_blank" title="Universitas Muhammadiyah Tangerang">
                            <img style="max-height: 150px; max-width:150px; padding: 20px;" src="assets/images-front/umt/umt.gif" alt="UMT" title="Universitas Muhammadiyah Tangerang">
                        </a>
                    </div>
                </div>
                <div class="owl-item">
                ...
                <div class="owl-item">
                    <div align="center">
                        <a href="https://kemdikbud.go.id/" target="_blank" title="Kementerian Pendidikan dan Kebudayaan">
                            <img style="max-height: 150px; max-width:150px; padding: 20px;" src="assets/images-front/umt/clcbji_taiwan.gif" alt="KEMENDIKBUD" title="Kementerian Pendidikan dan Kebudayaan">
                        </a>
                    </div>
                </div>
                <div class="owl-item">
                    <div align="center">
                        <a href="http://umt-online.seamolec.org/" target="_blank" title="Universitas Muhammadiyah Tangerang">
                            <img style="max-height: 150px; max-width:150px; padding: 20px;" src="assets/images-front/umt/hwa_new.jpg" alt="UMT" title="Universitas Muhammadiyah Tangerang">
                        </a>
                    </div>
                </div>
                <div class="owl-item">
                    <div align="center">
                        <a href="http://www.seamolec.org/" target="_blank" title="SEAMEO SEAMOLEC">
                            <img style="max-height: 150px; max-width:150px; padding: 20px;" src="assets/images-front/umt/umt.gif" alt="SEAMEO SEAMOLEC">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-7 col-sm-6 priorty wow fadeInLeft">
                        <h2 class="heading bottom25">Selamat datang di UMT Online  <span class="divider-left"></span></h2>
                        <p class="half_space text-justify">UMT Online dirancang untuk memberikan kemudahan tampilan sekaligus kontrol dalam pelaksanaan kelas digital.<br><br>
                            Sebagai <i>Learning Management System</i> (LMS), UMT Online menyediakan kelengkapan pembelajaran dari perancangan, pelaksanaan pembelajaran, sampai ke penilaian. Selain itu, UMT Online menyediakan materi pembelajaran dan soal yang dikembangkan oleh dosen.
                        </p>
                    </div>
                    <div class="col-md-5 col-sm-6 wow fadeInRight">
                        <img src="assets/images-front/umt/index.jpg" alt="our priorties" class="img-responsive" style="width:100%;">
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="icon_wrap padding-bottom-half clearfix">
                        ...
                        <div class="col-sm-4 icon_box text-center heading_space wow fadeInUp" data-wow-delay="400ms">
                            ...
                            <p class="no_bottom" style="text-align: justify;">UMT Online dirancang untuk memberikan kontrol penuh atas kelas digital Anda.
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-4 footer_panel bottom25">
                        <h3 class="heading bottom25">Tentang UMT Online<span class="divider-left"></span></h3>
                        <a href="./" class="footer_logo bottom25"><img src="assets/images-front/umt/umt-logo.png" width="150px" alt="Edua"></a>
                        <p>UMT Online adalah sebuah aplikasi <i>Learning Management System</i> yang dirancang untuk pembelajaran jarak jauh di Universitas Muhammadiyah Tangerang.</p>
                    </div>
                    <div class="col-md-4 col-sm-4 footer_panel bottom25">
                    </div>
                    <div class="col-md-4 col-sm-4 footer_panel bottom25">
                        <h3 class="heading bottom25">Universitas Muhammadiyah Tangerang <span class="divider-left"></span></h3>
                        <p class=" address"><p class=" address"><i class="icon-office"></i>
                        Jl.Perintis Kemerdekaan 1 No.33 Cikokol Tangerang, Kota Tangerang<br>
                        Banten, Indonesia</p>
                        <p class=" address"><i class="icon-mail"></i><a href="ditpmpk@kemdikbud.go.id">info@umt.ac.id</a></p>
                        <img src="assets/img/front/footer-map-white.png" alt="we are here" class="img-responsive">
                    </div>
                </div>
                <div class="row copyright">
                    <div class="col-md-12 text-center">
                        <p>Copyright &copy; 2021 <a href="https://umt.ac.id/" target="_blank">Universitas Muhammadiyah Tangerang</a>. all rights reserved.</p>
                    </div>
                </div>
            </div>
        </footer>

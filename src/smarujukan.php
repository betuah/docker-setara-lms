    ...
    <body class="pushmenu-push">
        ...
        <section class="" id="text_rotator_parent">
            <div id="text_rotator" class="owl-carousel">
                <div class="item" style="background:url(assets/img/front/8.png) no-repeat; background-size: cover;">
                    <div class="rotate_caption text-center">
                        <h1>Selamat datang di SIAJAR</h1>
                        <p>Cara paling aman dan mudah untuk menghubungkan guru dan siswa dalam pembelajaran<br>SMA (dalam jaringan).</p>
                        <br>
                        <br>
                        <br>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-5 col-sm-6 wow fadeInRight">
                        <img src="assets/img/front/9.png" alt="our priorties" class="img-responsive" style="width:100%;">
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-4 footer_panel bottom25">
                        ...
                        <p>SIAJAR adalah sebuah aplikasi <i>Learning Management System</i> yang dirancang untuk pembelajaran jarak jauh SMA dan SMK.</p>
                    </div>
                    <div class="col-md-4 col-sm-4 footer_panel bottom25">
                    </div>
                    <div class="col-md-4 col-sm-4 footer_panel bottom25">

...
$folder_name	= $_SESSION['lms_id'];


$upload_dir 	= '/assets/directory/'.$folder_name.'/';
$current_path 	= '../../assets/directory/'.$folder_name.'/';
$thumbs		= '../thumbs/';

if (!file_exists($upload_dir)) {
	$old = umask(0);
	mkdir('../../assets/directory/'.$folder_name.'/', 0777);
	umask($old);
}
...
$config = array(
	...
	*/
	...
	// but for security reasons it's NOT RECOMMENDED! array( 'txt', 'log', 'xml', 'html', 'css', 'htm', 'js' )
	...
	'ext_misc'                                => array( 'zip', 'gz', 'tar', 'iso', 'dmg' ), //Archives 'rar',

                                 ...
                                 <a href="index.php?menu=nilai" class="btn-flat btn-floating cyan waves-effect waves-light  btn tooltipped" data-position="top" data-delay="50" data-tooltip="Refresh"><i class="mdi-navigation-refresh"></i></a>
                                    ...
                                    if(isset($_POST['kelas'])){
                                     ...
                                     <tr>
                                           ...
                                           <th>Nama Siswa</th>
                                           <th style="display: none;"><center>Semester</center></th>
                                           <th>Mata Pelajaran</th>
                                           <th><center>Modul 1</center></th>
                                           <th><center>Modul 2</center></th>
                                           <th><center>Modul 3</center></th>
                                           <th style="display: none;"><center>UTS</center></th>
                                           <th style="display: none;"><center>UAS</center></th>
                                    ...
                                    while($cari2=mysql_fetch_array($cari)){
                                      ?>
                                        <tr>
                                           ...
                                           <td style="display: none;"><center><?php echo"$cari2[semester]";?></center></td>
                                           ...
                                           <td style="display: none;"><center><?php echo"$cari2[nilai_uts]";?></center></td>
                                           <td style="display: none;"><center><?php echo"$cari2[nilai_uas]";?></center></td>

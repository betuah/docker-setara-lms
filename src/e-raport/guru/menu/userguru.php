<div id="table-datatables">   
                        <form action="aksi.php?menu=userguru&aksi=edit" method="post" onSubmit="return validasi_guruedit(this);" enctype="multipart/form-data" class="col s12">
                        <div class="row">
                            <div class="col s12 m12 l12">
                            <div class="card-panel">
                            <h4 class="header2">Form Pengaturan</h4>
                             <input id="username" type="hidden" name="username" value="<?php echo $_SESSION['user']; ?>" class="validate">
                             <div class="row">

	    			...
	    			$menu = '<li class="brown">
					        ...
					        <li class="red">
					            <a href="sekolah.php">
					                ...
					                <span class="lbl">Satuan Pendidikan</span>
					            </a>
					        </li>
							<li class="magenta">

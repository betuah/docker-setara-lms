	                ...
	                <div class="chart-statistic-box">
	                    ...
	                    <div class="chart-container">
	                        <div class="chart-container-in">
	                            ...
	                            <header class="chart-container-title">Pedaftar Bulan ini</header>
	                ...
	                <div class="row">
						<div class="col-sm-6">
							<article class="statistic-box green">
								<div>
									<div class="number"><?=$dataDashboard['jmlSatuan']?></div>
									<div class="caption"><div>Satuan Pendidikan</div></div>
								</div>
							</article>
						</div><!--.col-->
	                    <div class="col-sm-6">
	                        <article class="statistic-box yellow">
	                            <div>
	                                <div class="number"><?=$dataDashboard['jmlSiswa']+$dataDashboard['jmlGuru']?></div>
	                                <div class="caption"><div>User</div></div>
	                            </div>
	                        </article>
	                    </div><!--.col-->
	                    <div class="col-sm-6">

...
if(isset($method['action'])){
    if ($_SERVER['SERVER_ADDR'] == '118.98.228.52') {
        ...
        if($method['action'] == 'getAll'){
           ...
           if ($mapel != 0) {
            ...
            $data           = $modulClass->GetAll($skip, $limit, $criteria, $order);
        ...
        $resp   = array('response'=>'invalid', 'message'=>'Forbidden access! ');
        $Json   = json_encode($resp);
        header('Content-Type: application/json');

...
if(isset($_POST['addQuiz'])){
	...
	if (!empty($_POST['idmodul'])) {
		...
		$rest = $quizClass->addQuiz($nama, $infoMapel['id_kelas'], $_GET['modul'], $_POST['durasi'], $mulai, $selesai, $_POST['instruksi'], $_SESSION['lms_id'], $_POST['jenis']);
	}
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title" id="addModulLabel">Tambah Penilaian Hasil Belajar</h4>
				</div>
				<div class="modal-body">
					<div class="form-group row">
					...
					<div class="form-group row">
						<label class="col-md-3 form-control-label" name="durasi" for="exampleInput">Bentuk Penilaian</label>
						<div class="col-md-9">
									...
									<div class="tbl info-tbl">
										<div class="tbl-row">
											<div class="tbl-cell">
												...
												<p class="title">Penilaian <?=$infoModul['nama']?></p>
							...
							?>
								<article class="box-typical profile-post panel">
									<div class="profile-post-header">
										<div class="user-card-row">
											<div class="tbl-row">
												...
												<?php if ($hakKelas['status'] == 1 || $_SESSION['lms_id'] == $materi['creator']) {?>
									...
									<div id="demo<?=$no?>" class="profile-post-content collapse">
										...
										<b><i class="fa fa-book"></i> Bentuk Penilaian :</b> <?=($materi["jenis"] == "0"? "Ulangan":"Ujian")?><br />
										...
										<hr style="margin: 10px 0;">
										<b><i class="fa fa-calendar-check-o"></i> Nilai Penilaian Hasil Belajar :</b> <span style="font-size: 1.5em; text-decoration: underline"><?=$nilaiQuiz['nilai']?></span> <br />
										<?php
											}else{
												$jumlah_soal    = $soalClass->getNumberbyQuiz($materi['id_paket']);
										?>
										...
										<div class="row">
											<div class="col-md-12">
												<a href="print-quiz?id=<?=$materi['_id']?>&paket=<?=$materi['id_paket']?>" class="btn btn-rounded btn-primary pull-right" title="Print" data-toggle="popover" data-placement="left" data-trigger="hover" data-content="Tombol untuk print penilaian hasil belajar." style="right: 60px" target="_blank">

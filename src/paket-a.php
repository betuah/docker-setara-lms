<?php
    ...
    $countUser  = $ClassUser->CountUserByProgram("Paket A");
    $countguru = $ClassUser->CountGuruByProgram("Paket A");
    $countsiswa = $ClassUser->CountSiswaByProgram("Paket A");
    $countmedia = $ClassMedia->CountMediaByKategori("5acadc6b865eacae5c8f190c");
?>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-5 col-sm-6 wow fadeInRight">
                        <img src="assets/img/front/paket-A.png" alt="our priorties" class="img-responsive" style="width:100%;">
                    </div>
                </div>
            </div>

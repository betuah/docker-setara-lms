            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-7 col-sm-6 priorty wow fadeInLeft">
                        ...
                        <p class="half_space text-justify">Secara tersistem seTARA daring terhubung sekaligus terintegrasi dengan <a href="sumberbelajar.seamolec.org"><b>Sumber Belajar</b></a> sehingga guru dapat mengelola pembelajaran dengan aman dan cepat. SIAJAR dirancang untuk memberikan kemudahan tampilan sekaligus kontrol dalam pelaksanaan kelas digital.<br><br>
                        Sebagai <i>Learning Management System</i> (LMS), seTARA daring menyediakan kelengkapan pembelajaran dari perancangan, pelaksanaan pembelajaran, sampai ke penilaian. Karena Penilaian Akhir seperti PTS (Penilaian Tengah Semester), PAS (Penilaian Akhir Semester), dan PAT (Penilaian Akhir Tahun) dilaksanakan di sekolah, maka SIAJAR hanya menyediakan materi pembelajaran dan soal yang dikembangkan oleh guru sebagai wahana berlatih menghadapi Penilaian Akhir tahun dan Ujian Nasional yang sesungguhnya.
</p>
                    </div>
                    <div class="col-md-5 col-sm-6 wow fadeInRight">
                        <img src="assets/img/front/paket-C.png" alt="our priorties" class="img-responsive" style="width:100%;">
                    </div>
                </div>
            </div>
